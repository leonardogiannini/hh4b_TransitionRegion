...
QCD = DIST("Data", "QCD_transitionRegion_CMVA.root", "MyTree", "(2200.*cross_section*puWeight/norm)")
...
tag = "cross_section<100000&(fatjet_mass<130&fatjet_mass>90)&(dijet_mass<140&dijet_mass>100)&isCR<0.4&&abs(cross_section-1)>0.5"
antitag = "cross_section<100000&(fatjet_mass<130&fatjet_mass>90)&(dijet_mass<140&dijet_mass>100)&isCR>0.4&&abs(cross_section-1)>0.5"
