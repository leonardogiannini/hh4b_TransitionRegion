...
QCD = DIST("Data", "QCD_transitionRegion.root", "MyTree", "(2200.*cross_section*puWeight/norm)")

TTjets= DIST("Data", "QCD_transitionRegion.root", "MyTree", "(2200.*1.3*cross_section*puWeight/norm)*(abs(cross_section-831.5)<0.5)")
...
#*****************************************************************************************###
presel="cross_section<100000&&Inv_mass<798&&abs(cross_section-1)>0.5"
print presel
...
# cuts:
tag = "Inv_mass<798&&cross_section<100000&(fatjet_mass<130&fatjet_mass>90)&(dijet_mass<140&dijet_mass>100)&fatjet_hbb>0.4&&abs(cross_section-1)>0.5"
antitag = "Inv_mass<798&&cross_section<100000&(fatjet_mass<130&fatjet_mass>90)&(dijet_mass<140&dijet_mass>100)&fatjet_hbb<0.4&&abs(cross_section-1)>0.5"
...
presel="cross_section<100000&&Inv_mass>798&&Inv_mass<1208&&abs(cross_section-1)>0.5"
print presel
HbbTest.SetRegionsDouble(var_array, presel)
HbbTest.ThreeDPlot.Draw() # Show that plot:
HbbTest.GetRatesDouble(cut, bins, bins2, truthbins, truthbins2, center, center2, F)
...
leg.Draw()
CMS_lumi.CMS_lumi(C2, iPeriod, 22)
C2.Print("fitBu_bbtag%s.pdf"%cut[0])
# Now we actually run the estiamte!

# cuts:

tag = "Inv_mass>798&&Inv_mass<1208&&cross_section<100000&(fatjet_mass<130&fatjet_mass>90)&(dijet_mass<140&dijet_mass>100)&fatjet_hbb>0.4&&abs(cross_section-1)>0.5"
antitag = "Inv_mass>798&&Inv_mass<1208&&cross_section<100000&(fatjet_mass<130&fatjet_mass>90)&(dijet_mass<140&dijet_mass>100)&fatjet_hbb<0.4&&abs(cross_section-1)>0.5"
...
presel="cross_section<100000&&Inv_mass>1208&&abs(cross_section-1)>0.5"
print presel
HbbTest.SetRegionsDouble(var_array, presel)
HbbTest.ThreeDPlot.Draw() # Show that plot:
HbbTest.GetRatesDouble(cut, bins, bins2, truthbins, truthbins2, center, center2, F)
...
leg.Draw()
CMS_lumi.CMS_lumi(C2, iPeriod, 22)
C2.Print("fit3_bbtag%s.pdf"%cut[0])
# Now we actually run the estiamte!

# cuts:

tag = "Inv_mass>1208&&cross_section<100000&(fatjet_mass<130&fatjet_mass>90)&(dijet_mass<140&dijet_mass>100)&fatjet_hbb>0.4&&abs(cross_section-1)>0.5"
antitag = "Inv_mass>1208&&cross_section<100000&(fatjet_mass<130&fatjet_mass>90)&(dijet_mass<140&dijet_mass>100)&fatjet_hbb<0.4&&abs(cross_section-1)>0.5"
