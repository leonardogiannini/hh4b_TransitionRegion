...
mass=[500, 550, 650, 700, 900, 1000, 1200, 1800, 2000]
VAR = "Inv_mass"
...
vartitle = "m_{X} (GeV)"
sigregcut = "cross_section<100000&(fatjet_mass<130&fatjet_mass>90)&(dijet_mass<140&dijet_mass>100)&fatjet_hbb>0.4"
lumi =2190.
...
QCD.Scale(mc_norm*SF_tau21*SF_tau21*SF_bbtag)
QCD_Antitag.Scale(mc_norm*SF_tau21*SF_bbtag)
QCD_CMS_scale_13TeVUp.Scale(mc_norm*SF_tau21*SF_bbtag)
QCD_CMS_scale_13TeVDown.Scale(mc_norm*SF_tau21*SF_bbtag)
data_obs.Scale(mc_norm*SF_tau21*SF_bbtag)
...
#	print(generatedEvents)
	...
	writeplot(tree, Signal_mX, VAR, sigregcut, "puWeight")
	print(Signal_mX.Integral())
	Signal_mX.Scale(lumi*0.01*SF_tau21*SF_tau21*SF_bbtag/100.)
