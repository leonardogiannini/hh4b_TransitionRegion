...
def tree_selection(file_string, isData=0, dataset="", cross_section=1.,bbtag_cut=0.8,jet_btag_cut=0.185):
    ...
    AnaysisFile=TFile("../optimization/selected"+Tag+name, "recreate")
...
def tree_controlregion(file_string, isData=0, dataset="", cross_section=1.,bbtag_cut=0.8,jet_btag_cut=0.185):
    ...
    AnaysisFile=TFile("../optimization/selectedAtag"+Tag+name, "recreate")
