            ...
            if (tree.Vtype==-1 or tree.Vtype==4):
                ...
                if (count_jetsoutsidef>=2 and count_fatjets>=1):
                    ...
                    for j in save_index:
                        ...
                        if (systematic=="FJEC_Up"): mpruned_syst=tree.FatjetAK08ungroomed_mpruned[j]*tree.FatjetAK08ungroomed_JEC_L2L3_UP[j]
