...
mass=[1000,1200, 1400,1600, 1800,2000,2500,3000, 1100, 1300, 1500, 1700, 1900, 2100, 2300, 2600, 2700, 2800, 2900]
sim_masses=[1000,1200,1400,1600,1800,2000,2500,3000]
VAR = "inv_mass_corr"
...
#        tree.Print()
        ...
        temp1 = TH1F("temp1", "",100, 800, 3019)
        temp2 = TH1F("temp2", "",100, 800, 3019)
